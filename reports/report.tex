...
% \usepackage[language=australian,style=apa]{biblatex}
...
\begin{figure}[h!]
    ...
    \end{subfigure} 
    \hspace{0.05\textwidth} % good when the figures are larger and touch in the middle of the page not needed for this example though. 
    \begin{subfigure}[b]{0.4\textwidth}
        \center
